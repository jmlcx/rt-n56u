...
#undef  BOARD_GPIO_LED_WIFI	5
#define BOARD_GPIO_LED_SW2G 4
#define BOARD_GPIO_LED_SW5G 5
#undef  BOARD_GPIO_LED_ALL
#define BOARD_GPIO_LED_POWER 1
#undef  BOARD_GPIO_LED_LAN
#define BOARD_GPIO_LED_LAN1 9
#define BOARD_GPIO_LED_LAN2 11
#define BOARD_GPIO_LED_LAN3 13
#define BOARD_GPIO_LED_LAN4 15
#define BOARD_GPIO_LED_WPS 17
#define BOARD_GPIO_LED_WAN 3
#define BOARD_GPIO_LED_USB 6
#define BOARD_GPIO_LED_USB2 7
